              ...
              <label className="flex flex-col min-w-40 h-12 w-full">
                <div className="flex w-full items-stretch rounded-xl h-full relative">
                  ...
                  <input
                    ...
                    className="form-input w-full flex-1 rounded-xl text-[#1b130d] bg-[#f3ece7] focus:outline-0 pl-10 pr-4 placeholder:text-[#9a6e4c]"
                    value={searchValue}
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-4 p-4">
              {recipesToShow
                ...
                .map((recipe, index) => (
                  <div
                    key={index}
                    className="flex flex-col gap-3 pb-3 cursor-pointer hover:scale-105 transition-transform"
